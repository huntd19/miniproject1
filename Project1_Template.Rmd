...
Many variables come into play when answering the question if schools can afford to pay their players. Do schools’ athletic expenses equal their revenue? Are they making a profit? Or are they losing money from their athletics? Athletic departments, especially at the division one level, have many expenses. They have the pay for coaches, trainers, facilities, travel, hotels, etc. But they also have a few ways of obtaining revenue. Ticket sales, merchandise sales, and tv revenue are just a few ways that athletic departments produce revenue. 

We investigated both athletic revenue and expenses from these 5 years. Both variables were inflation adjusted to give an accurate representation of these variables over the years. Additionally, all universities were filtered into athletic conference. This step occurred because each conference is different and has different circumstances. For instance, some conferences like the Big 10 have their own tv network allowing them to produce revenue easier. Five conferences known as the power five were highlighted also. These conferences are the best conferences in competition and are the most widely known. 

After filtering out by conference we see a discrepancy in revenue generated by different conferences. Also, expenses were seen to decrease as revenue decreased. Some conferences the expenses were seen as essentially equal to the revenue produced. Meaning schools on average were not making a distinguishable profit. But other the power five conferences were seen to have made some profit. This is seen in the bar graph located above the average expenses line. These findings tell us that some conferences do have the requisite revenue to pay its players. But some conferences do not have the money to spare. This study produces a mixed result and gives an example as to why this issue is not a complex issue. Some universities can afford to pay their players, but other universities do not have the money to pay them.
